...
export function CapabilityScopeSelector({
  ...
  /** Plugins labels its scope as Agent because desktop halves belong to the
   *  app, not this profile. */
  agentLabel: boolean
  ...
  return (
    <div className="flex min-w-0 items-center gap-2 border-b border-(--ui-stroke-secondary) px-3 py-2">
      <span className="text-[0.7rem] font-medium text-(--ui-text-tertiary)">
        {agentLabel ? t.skills.plugins.halfAgent : t.skills.configuringProfile}
      </span>
